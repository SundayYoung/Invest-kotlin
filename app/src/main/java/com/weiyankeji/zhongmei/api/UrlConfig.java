package com.weiyankeji.zhongmei.api;
...
public final class UrlConfig {
    ...
    //https://www.mxis-tech.com
    public static final String RELEASE_BASE_URL = "https://www.mxis-tech.com/";
    private static final String DEBUG_BASE_URL = "http://47.93.24.29:8183/";


    //https://www.mxis-tech.com/h5/
    private static final String RELEASE_H5_BASE_URL = "https://www.mxis-tech.com/h5/";

    private static final String APP_URL_EXTRA = "api/mobile/";
    private String mUrlType;


    private UrlConfig(String uri) {
        mRelativePath = uri;
        mUrlType = (String) SharedPreferencesUtil.get(ZMApplication.getZMContext(), ZMApplication.getZMContext().getString(R.string.debug_cache_name), ConstantUtils.DEBUG_URL, "");
    }
    ...
    private String build() {
        ...
        if (StringUtil.isNullOrEmpty(mUrlType)) {
            mUrlBuilder.append(BuildConfig.DEBUG ? DEBUG_BASE_URL : RELEASE_BASE_URL);
        } else {
            mUrlBuilder.append(mUrlType.equals(ZMApplication.getZMContext().getString(R.string.debug_release)) ? RELEASE_BASE_URL : RELEASE_BASE_URL);
        }
        mUrlBuilder.append(APP_URL_EXTRA);
    ...
    //分享信息
    public static final String INVATE_SHARE = getUrl("user-invite/share");
     ...
     */
    //注册协议
    public static final String REGISTER_PROTOCOL = getProtocolUrl("agr-register-app");
    public static final String PRIVACY_PROTOCOL = getProtocolUrl("agr-privacy-protocol-app");
    ...
    private static String getH5Url(String path) {
        StringBuilder mUrlBuilder = new StringBuilder();
        mUrlBuilder.append(BuildConfig.DEBUG ? DEBUG_BASE_URL : RELEASE_H5_BASE_URL);
        mUrlBuilder.append(path);
        return mUrlBuilder.toString();
    }

    private static String getProtocolUrl(String path) {
        StringBuilder mUrlBuilder = new StringBuilder();
        mUrlBuilder.append(BuildConfig.DEBUG ? DEBUG_BASE_URL : RELEASE_BASE_URL);
        mUrlBuilder.append(path);
        return mUrlBuilder.toString();
